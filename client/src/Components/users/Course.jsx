            ...
            >
              ...
              <div className="p-4 w-[15rem]">
                ...
                <Link
                  ...
                  className="w-full inline-block px-3 py-2 text-xs lg:text-xs md:text-xs font-bold text-white bg-gray-800 rounded-full hover:bg-gray-700 focus:outline-none"
                >
                  Read More
                </Link>
